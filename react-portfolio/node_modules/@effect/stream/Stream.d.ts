...
export declare const aggregateWithin: {
    ...
    <R, E, R2, E2, A, A2, B, R3, C>(self: Stream<R, E, A>, options: {
        readonly sink: Sink.Sink<R2, E2, A | A2, A2, B>;
        readonly schedule: Schedule.Schedule<R3, Option.Option<B>, C>;
...
export declare const scheduleWith: {
    <R2, A, B, C>(schedule: Schedule.Schedule<R2, A, B>, options: {
        readonly onElement: (a: A) => C;
        readonly onSchedule: (b: B) => C;
    }): <R, E>(self: Stream<R, E, A>) => Stream<R2 | R, E, C>;
    <R, E, R2, A, B, C>(self: Stream<R, E, A>, schedule: Schedule.Schedule<R2, A, B>, options: {
        readonly onElement: (a: A) => C;
        readonly onSchedule: (b: B) => C;
    }): Stream<R | R2, E, C>;
};
