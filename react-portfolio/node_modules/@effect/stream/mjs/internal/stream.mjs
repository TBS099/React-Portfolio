...
/** @internal */
export const aggregate = /*#__PURE__*/dual(2, (self, sink) => aggregateWithin(self, {
  sink,
  schedule: Schedule.forever
}));
/** @internal */
export const aggregateWithin = /*#__PURE__*/dual(2, (self, options) => filterMap(aggregateWithinEither(self, options), _ => Either.match(_, {
  onLeft: Option.none,
  onRight: Option.some
})));
/** @internal */
export const aggregateWithinEither = /*#__PURE__*/dual(2, (self, {
  schedule,
  sink
}) => {
...
/** @internal */
export const groupedWithin = /*#__PURE__*/dual(3, (self, chunkSize, duration) => aggregateWithin(self, {
