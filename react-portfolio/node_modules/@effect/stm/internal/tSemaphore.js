...
const withPermitsScoped = /*#__PURE__*/(0, _Function.dual)(2, (self, permits) => Effect.acquireRelease(core.commit(acquireN(self, permits)), () => core.commit(releaseN(self, permits)), {
  interruptible: true
}));
/** @internal */
