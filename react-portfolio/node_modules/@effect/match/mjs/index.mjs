...
export const tagsExhaustive = tagsExhaustive_1;
/**
 * @category combinators
 ...
 * @since 1.0.0
 */
export const instanceOfUnsafe = instanceOf_1;
/**
 ...
 * @since 1.0.0
 */
export const orElseAbsurd = self => orElse_1(() => {
...
export const exhaustive = exhaustive_1;
