...
/* @internal */
export const annotateLogs = /*#__PURE__*/dual(3, (effect, key, value) => core.flatMap(core.fiberRefGet(core.currentLogAnnotations), annotations => core.suspend(() => core.fiberRefLocally(core.currentLogAnnotations, HashMap.set(annotations, key, value))(effect))));
/* @internal */
export const annotateSpans = /*#__PURE__*/dual(3, (self, key, value) => core.flatMap(core.fiberRefGet(core.currentTracerSpanAnnotations), annotations => core.suspend(() => core.fiberRefLocally(core.currentTracerSpanAnnotations, HashMap.set(annotations, key, value))(self))));
/* @internal */
export const asSome = self => core.map(self, Option.some);
/* @internal */
export const asSomeError = self => core.mapError(self, Option.some);
/* @internal */
export const asyncOption = (register, blockingOn = FiberId.none) => core.asyncInterruptEither(cb => {
...
/* @internal */
export const currentSpan = /*#__PURE__*/core.map( /*#__PURE__*/core.fiberRefGet(core.currentTracerSpan), List.head);
/* @internal */
...
/* @internal */
export const withLogSpan = /*#__PURE__*/dual(2, (effect, label) => core.flatMap(core.fiberRefGet(core.currentLogSpan), stack => core.flatMap(Clock.currentTimeMillis, now => core.suspend(() => core.fiberRefLocally(core.currentLogSpan, List.prepend(stack, LogSpan.make(label, now)))(effect)))));
/* @internal */
...
/* @internal */
export const promise = evaluate => core.async(resolve => {
  evaluate().then(a => resolve(core.exitSucceed(a))).catch(e => resolve(core.exitDie(e)));
});
/* @internal */
export const promiseInterrupt = evaluate => core.asyncInterruptEither(resolve => {
...
/* @internal */
export const tryPromise = arg => core.flatMap(try_(arg), promise => core.async(resolve => {
  promise.then(a => resolve(core.exitSucceed(a))).catch(e => resolve(core.exitFail("catch" in arg ? arg.catch(e) : e)));
}));
/* @internal */
export const tryPromiseInterrupt = arg => {
...
/* @internal */
export const tryMapPromiseInterrupt = /*#__PURE__*/dual(2, (self, options) => core.flatMap(self, a => tryPromiseInterrupt({
...
/** @internal */
export const withSpan = /*#__PURE__*/dual(args => typeof args[0] !== "string", (self, name, options) => useSpan(name, options ?? {}, span => core.flatMap(core.fiberRefGet(core.currentTracerSpan), stack => core.fiberRefLocally(self, core.currentTracerSpan, List.prepend(stack, span)))));
/* @internal */
