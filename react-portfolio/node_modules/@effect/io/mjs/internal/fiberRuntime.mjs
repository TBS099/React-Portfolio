...
/** @internal */
export const fiberLifetimes = /*#__PURE__*/metric.histogram("effect_fiber_lifetimes", /*#__PURE__*/metricBoundaries.exponential({
  start: 1.0,
  factor: 2.0,
  count: 100
}));
...
/* @internal */
export const acquireRelease = /*#__PURE__*/dual(args => core.isEffect(args[0]), (acquire, release, options) => {
...
/* @internal */
export const addFinalizer = finalizer => core.flatMap(core.context(), context => core.flatMap(scope, scope => core.scopeAddFinalizerExit(scope, exit => core.asUnit(core.provideContext(context)(finalizer(exit))))));
/* @internal */
...
/* @internal */
export const replicateEffect = /*#__PURE__*/dual(args => core.isEffect(args[0]), (self, n, options) => all(replicate(n)(self), options));
// @ts-expect-error
...
/* @internal */
export const unsome = self => core.matchEffect(self, {
  onFailure: option => {
    switch (option._tag) {
      case "None":
        {
...
//
/** @internal */
export const raceWith = /*#__PURE__*/dual(2, (self, options) => raceFibersWith(self, {
  other: options.other,
...
/** @internal */
export const race = /*#__PURE__*/dual(2, (self, that) => core.checkInterruptible(isInterruptible => raceAwait(raceDisconnect(that, isInterruptible))(raceDisconnect(self, isInterruptible))));
/** @internal */
...
/** @internal */
export const raceAwait = /*#__PURE__*/dual(2, (self, that) => core.fiberIdWith(parentFiberId => raceWith(self, {
  other: that,
  onSelfDone: (exit, right) => core.exitMatchEffect(exit, {
    onFailure: cause => mapErrorCause(cause2 => internalCause.parallel(cause, cause2))(internalFiber.join(right)),
    onSuccess: value => core.as(value)(core.interruptAsFiber(parentFiberId)(right))
  }),
  onOtherDone: (exit, left) => core.exitMatchEffect(exit, {
    onFailure: cause => mapErrorCause(cause2 => internalCause.parallel(cause2, cause))(internalFiber.join(left)),
    onSuccess: value => core.as(value)(core.interruptAsFiber(parentFiberId)(left))
  })
})));
/** @internal */
export const raceFibersWith = /*#__PURE__*/dual(2, (self, options) => core.withFiberRuntime((parentFiber, parentStatus) => {
  const parentRuntimeFlags = parentStatus.runtimeFlags;
...
/** @internal */
export const invokeWithInterrupt = (dataSource, all) => core.fiberIdWith(id => core.flatMap(core.flatMap(forkDaemon(core.interruptible(dataSource)), processing => core.asyncInterrupt(cb => {
