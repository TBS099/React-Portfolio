...
export declare namespace All {
    ...
    interface Signature {
        <Arg extends Iterable<EffectAny> | Record<string, EffectAny>, O extends Options>(arg: Narrow<Arg>, options?: O): [Arg] extends [ReadonlyArray<EffectAny>] ? ReturnTuple<Arg, IsDiscard<O>, ExtractMode<O>> : [Arg] extends [Iterable<EffectAny>] ? ReturnIterable<Arg, IsDiscard<O>, ExtractMode<O>> : [Arg] extends [Record<string, EffectAny>] ? ReturnObject<Arg, IsDiscard<O>, ExtractMode<O>> : never;
    }
    interface SignatureWith {
        <O extends Options>(options?: O): <Arg extends Iterable<EffectAny> | Record<string, EffectAny>>(arg: Arg) => [Arg] extends [ReadonlyArray<EffectAny>] ? ReturnTuple<Arg, IsDiscard<O>, ExtractMode<O>> : [Arg] extends [Iterable<EffectAny>] ? ReturnIterable<Arg, IsDiscard<O>, ExtractMode<O>> : [Arg] extends [Record<string, EffectAny>] ? ReturnObject<Arg, IsDiscard<O>, ExtractMode<O>> : never;
    }
}
/**
...
export declare const acquireRelease: {
    <A, R2, X>(release: (a: A, exit: Exit.Exit<unknown, unknown>) => Effect<R2, never, X>, options?: {
        readonly interruptible?: false;
    }): <R, E>(acquire: Effect<R, E, A>) => Effect<R2 | R | Scope.Scope, E, A>;
    <A, R2, X>(release: (exit: Exit.Exit<unknown, unknown>) => Effect<R2, never, X>, options?: {
        readonly interruptible: true;
    }): <R, E>(acquire: Effect<R, E, A>) => Effect<Scope.Scope | R2 | R, E, A>;
    <R, E, A, R2, X>(acquire: Effect<R, E, A>, release: (a: A, exit: Exit.Exit<unknown, unknown>) => Effect<R2, never, X>, options?: {
        readonly interruptible?: false;
    }): Effect<Scope.Scope | R | R2, E, A>;
    <R, E, A, R2, X>(acquire: Effect<R, E, A>, release: (exit: Exit.Exit<unknown, unknown>) => Effect<R2, never, X>, options?: {
        readonly interruptible: true;
    }): Effect<Scope.Scope | R | R2, E, A>;
};
/**
...
export declare const filterOrDie: {
    <A, B extends A>(filter: Refinement<A, B>, orDieWith: LazyArg<unknown>): <R, E>(self: Effect<R, E, A>) => Effect<R, E, B>;
 ...
 * @category logging
 */
export declare const log: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logTrace: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logDebug: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logInfo: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logWarning: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logError: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
 ...
 * @category logging
 */
export declare const logFatal: <A extends string | Cause.Cause<unknown>>(messageOrCause: A, supplementry?: A extends string ? Cause.Cause<unknown> : string) => Effect<never, never, void>;
/**
